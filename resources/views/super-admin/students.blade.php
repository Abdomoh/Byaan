                    ...
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="5" style="text-align: center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $student->name }}</td>
                                <td>{{ $student->email }}</td>
                                <td>{{$student->type->type}}</td>
                            
                                <td><img src="/uploads/{{$student->url}}" style=" width: 30px;" class="img-thumbnail" data-toggle="modal" data-target="#img_show{{ $student->id }}"></td>
                            ...
                            <!--  img- show -->
                            <div class="modal fade" id="img_show{{$student->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <center><img src="/uploads/{{$student->url}}" width="400px" class="rounded-circle"></center>
